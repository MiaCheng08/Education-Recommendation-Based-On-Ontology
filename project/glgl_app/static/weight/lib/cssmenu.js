(function($) {
  ...
  $.fn.menumaker = function(options) {
      ...
      return this.each(function() {
        cssmenu.prepend('<div id="menu-button"><img style="width:25px; background-color:white; padding:5px; margin:0 5px 0 5px;" src="../lib/styles/img/logo.png" class="logo">' + settings.title + '</div>');
